...
<head>
  <title>Automatic Livestock Feeder Management System</title>
  <!-- [Meta] -->
  <meta charset="utf-8">
  ...
  <!-- [Favicon] icon -->
  <link rel="icon" href="templateForAuth/dist/assets/images/logos/alfms.png" type="image/x-icon">
  <!-- [Page specific CSS] start -->
  <link href="templateForAuth/dist/assets/css/plugins/animate.min.css" rel="stylesheet" type="text/css">
  ...
  <link rel="stylesheet" href="templateForAuth/dist/assets/css/landing.css">
</head>
  ...
  <header id="home">
    ...
    <nav class="navbar navbar-expand-md navbar-dark top-nav-collapse default">
      <div class="container">
        <a class="navbar-brand" href="#">
          <img src="templateForAuth/dist/assets/images/logos/alfms.png" alt="logo" style = "width: 130px; border-radius: 10px;">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            <li class="nav-item pe-1">
              <a class="nav-link" href="{{ route('toLogin') }}">Login</a>
            </li>
            <li class="nav-item">
              <a class="btn btn-primary" href="{{ route('toRegister') }}">Register</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center text-center">
        <div class="col-md-9 col-xl-7" style = "margin-top: 11px;">
          <h1 class="mt-sm-3 text-white mb-4 f-w-600 wow fadeInUp" data-wow-delay="0.2s" >Carefully Crafted for your
            <span class="text-primary">Automatic Livestock Feeder Management System</span>
          </h1>
          <h5 class="mb-4 text-white opacity-75 wow fadeInUp" data-wow-delay="0.4s">This system is a smart and efficient solution designed to automate livestock feeding processes with precision and ease.</h5>
          <div class="my-5 wow fadeInUp" data-wow-delay="0.6s">
            <a href="{{route('toLogin')}}" class="btn btn-outline-primary me-2">Explore Features</a>
          </div>
